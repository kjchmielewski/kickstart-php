...
# Network information
network --onboot yes --device eth0 --bootproto static --noipv6 --ip=172.19.243.<?php echo $HN ?> --netmask=255.255.255.0 --hostname=thimphu.dro.nask.pl
network --onboot yes --device eth1 --bootproto static --noipv6 --ip=10.243.255.<?php echo $HN ?> --netmask=255.255.255.0 --gateway=10.243.255.1 --nameserver=172.19.243.1
